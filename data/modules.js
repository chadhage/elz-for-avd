...
`,
    ...
    currentState: [
      ...
      { id: "current_tenant_ids", type: "textarea", label: "Tenant IDs in use (current state)", help: "List the Entra tenant IDs (GUIDs) currently used by the AVD estate.", placeholder: "e.g., 11111111-1111-1111-1111-111111111111 (commercial), 22222222-2222-2222-2222-222222222222 (gov)" },
      { id: "current_subscription_ids", type: "textarea", label: "Subscription IDs in use (current state)", help: "List the Azure subscription IDs (GUIDs) currently hosting AVD and its dependencies.", placeholder: "e.g., 33333333-3333-3333-3333-333333333333 (AVD prod), 44444444-4444-4444-4444-444444444444 (shared services)" },
      { id: "current_resource_groups", type: "textarea", label: "Resource group names in use (current state)", help: "List the resource groups that hold AVD session hosts, host pools, storage, networking, and shared services.", placeholder: "e.g., rg-avd-hostpools-prod, rg-avd-storage-prod, rg-network-hub" },
